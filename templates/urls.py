...
urlpatterns = [
    ...
    path('invoice/<int:invoice_id>/details/', views.invoice_list_view, name='invoice_details'),
    # path('turn_to_invoice/<int:quotation_id>/', views.turn_to_invoice, name='turn_to_invoice'),
    #Inovices and Quotations

    path('invoice/<int:pk>/details/', views.invoice_detail_view, name='invoice_details_view'),
    path('invoice/<int:invoice_id>/details/', views.invoice_list_view, name='invoice_details'),
    path('turn_to_invoice/<int:quotation_id>/', views.turn_to_invoice, name='turn_to_invoice'),
    ...
    path('patient_quotation/<int:patient_id>/', views.patient_quotation, name='patient_quotation'),
    ...
    path('invoices_list/', views.invoice_list_view, name='invoice_list'),
    path('invoice/<int:invoice_id>/detinvoiceails/', views.invoice_detail_view, name='invoice_details'),
    # path('create_quotation/', v # path('turn_to_invoice/<int:quotation_id>/', views.turn_to_invoice, name='turn_to_invoice'),iews.create_quotation, name='create_quotation'),
    # path('patient_invoice/<int:patient_id>/', views.patient_invoice, name='patient_invoice'),
    # path('create_inovice_list/', views.create_invoice_list_view, name='create_invoice_list'),
    # path('search_patient/', views.search_patient, name='search_patient'),
